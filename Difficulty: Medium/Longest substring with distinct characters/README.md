<h2><a href="https://www.geeksforgeeks.org/problems/longest-distinct-characters-in-string5848/1?sortBy=submissions&category%5B%5D=Strings&page=1&difficulty%5B%5D=0">Longest substring with distinct characters</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">You are given a string <strong>s</strong>.&nbsp;You have to find the length of the <strong>longest substring</strong> with all <strong>distinct </strong>characters.&nbsp;</span></p>
