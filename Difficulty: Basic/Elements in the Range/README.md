<h2><a href="https://www.geeksforgeeks.org/problems/elements-in-the-range2834/1?sortBy=submissions&category%5B%5D=Searching&page=1&difficulty%5B%5D=-1">Elements in the Range</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> containing positive elements. A and B are two numbers defining a range. The task is to check if the array contains <strong>all elements</strong> in the given range (inclusive).</span></p>
